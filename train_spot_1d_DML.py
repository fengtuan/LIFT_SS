...
if args.adapter=="lora":
    if args.lora_type=='selfattn':
        ...
        res_path= common_path+str(args.r)+'_'+args.lora_type+'_'+str(args.leave_out_num) 
    else:
        ...
        res_path= common_path+str(args.r)+'_'+"FF"+'_'+str(args.leave_out_num) 
    adapter_name="lora"
elif args.adapter=="ia3":
    config=IA3Config(leave_out=list(range(args.leave_out_num)))
    res_path= common_path+str(args.leave_out_num) 
    adapter_name="ia3"    
    ...
    res_path= common_path+str(args.reduction_factor)+'_'+args.non_linearity+'_'+str(args.adapter_type)+'_'+str(args.leave_out_num) 
    ...
    res_path= common_path+args.non_linearity+'_'+str(args.reduction_factor)+'_'+str(args.prefix_len)+'_'+str(args.leave_out_num)    
    ...
    res_path= common_path+args.non_linearity+'_'+str(args.reduction_factor)+'_'+str(args.prefix_len)+'_'+str(args.r)+'_'+str(args.leave_out_num)    
else:
    ...
    res_path= common_path+str(args.prefix_len)+'_'+str(args.leave_out_num) 
